...
/* harmony import */ var recoil__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(755);
...
/* harmony import */ var _hooks_useMoonraker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(277);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var react_use_websocket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(636);
...
const useMoonraker = (hostname)=>{
    var ref;
    const { lastJsonMessage , sendJsonMessage , readyState  } = useWebSocket(`ws://${((ref = hostname === null || hostname === void 0 ? void 0 : hostname.trim()) !== null && ref !== void 0 ? ref : '') != '' ? hostname : window.location.hostname}:7125/websocket`, {
    ...
    useEffect(()=>{
        ...
        readyState,
        setMoonrakerStatus,
        setMoonrakerReadyState
    ]);
    useEffect(()=>{
        if ((lastJsonMessage === null || lastJsonMessage === void 0 ? void 0 : lastJsonMessage.id) && inFlightRequests[lastJsonMessage.id]) {
